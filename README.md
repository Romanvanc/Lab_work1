...
ConvNeXt-Tiny с дообучением на Stanford Dogs dataset достигла 94.59% accuracy на 120 классах за 10 эпох. Adam и AdamW показали близкие результаты (разница менее 0.5%). Обучение с нуля неэффективно — модели требуют предобучения на больших датасетах (ImageNet) для выучивания базовых визуальных признаков. Отсутствие аугментации не является проблемой при дообучении, так как предобученная модель уже обладает робастностью.


### Список источников

1. Liu, Z. et al. "A ConvNet for the 2020s." arXiv:2201.03545, 2022.
2. Kingma, D. P. & Ba, J. "Adam: A Method for Stochastic Optimization." arXiv:1412.6980, 2015.
3. Loshchilov, I. & Hutter, F. "Decoupled Weight Decay Regularization." arXiv:1711.05101, 2019.
4. Stanford Dogs Dataset -- http://vision.stanford.edu/aditya86/ImageNetDogs/
5. PyTorch ConvNeXt documentation -- https://pytorch.org/vision/stable/models/convnext.html
