...
1. **Дообучение на предобученной ConvNeXt-Tiny дает высокую точность (94.6%)** при минимальных вычислительных затратах.
...
3. **Обучение с нуля не имеет смысла** — модель не выучивает осмысленные признаки за разумное число эпох. ConvNeXt, требует предобучения на ImageNet.
